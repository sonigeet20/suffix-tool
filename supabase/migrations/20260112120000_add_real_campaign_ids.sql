...
ADD COLUMN IF NOT EXISTS url1_campaign_id_real TEXT,
ADD COLUMN IF NOT EXISTS url2_campaign_id_real TEXT,
ADD COLUMN IF NOT EXISTS url1_campaign_id_display TEXT,
ADD COLUMN IF NOT EXISTS url2_campaign_id_display TEXT;

-- Add comments explaining the columns
COMMENT ON COLUMN trackier_offers.url1_campaign_id_real IS 'Actual Trackier internal campaign ID for URL1 (used in webhooks)';
COMMENT ON COLUMN trackier_offers.url2_campaign_id_real IS 'Actual Trackier internal campaign ID for URL2 (used in webhooks)';
COMMENT ON COLUMN trackier_offers.url1_campaign_id_display IS 'Display campaign ID for URL1 (simple number)';
COMMENT ON COLUMN trackier_offers.url2_campaign_id_display IS 'Display campaign ID for URL2 (simple number)';
